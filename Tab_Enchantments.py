...
from Frame_Enchant_Table import *
from Frame_Filter import *

class Tab_Enchantments:
    ...
    def __init__(self, color, tab, program_data):
        ...
        self.f_table = tk.LabelFrame(self.f_main, text="Enchantment Table", padx=5, pady=5, bg=self.color['background'], fg=self.color['header'], font=f)
        ...
        self.et = Frame_Enchant_Table(color, self.f_table)
