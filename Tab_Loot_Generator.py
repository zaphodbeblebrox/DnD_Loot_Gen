...
class Tab_Loot_Generator:
    ...
    def __init__(self, color, tab, programData):
        ...
        self.fGen2 = tk.LabelFrame(self.frameGen, text="Loot Level", padx=5, pady=5, bg=self.color['dark gray'], fg=self.color['pink'], font=f)
        self.fGen3 = tk.LabelFrame(self.frameGen, text="Type of Generation", padx=5, pady=5, bg=self.color['dark gray'], fg=self.color['pink'], font=f)
        self.fGen4 = tk.LabelFrame(self.frameGen, text="Item Rarity", padx=5, pady=5, bg=self.color['dark gray'], fg=self.color['pink'], font=f)
        self.fGen5 = tk.LabelFrame(self.frameGen, text="Item Types", padx=5, pady=5, bg=self.color['dark gray'], fg=self.color['pink'], font=f)
